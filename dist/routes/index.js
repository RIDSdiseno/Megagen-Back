...
router.get("/clients", auth_1.authRequired, (0, auth_1.requireRoles)(["admin", "superadmin", "supervisor", "vendedor"]), clientsController_1.listClients);
...
router.patch("/meetings/:id", auth_1.authRequired, (0, auth_1.requireRoles)(["admin", "superadmin", "supervisor", "vendedor"]), meetingsController_1.updateMeeting);
